		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Orders App Title",
									"targetURL": "#sapb1salesorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapb1salesorders-display": {
								"semanticObject": "sapb1salesorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapb1.salesorders",
									"url": sap.ui.require.toUrl("sapb1/salesorders")
								}
							}
						}
					}
